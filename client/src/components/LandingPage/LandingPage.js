...
export default function LandingPage() {
  ...
  return (
    ...
    className="bg-cover bg-center h-screen flex items-center justify-center w-full h-auto"
    >
      {/* <div 
        style={{ backgroundImage: `url(${backgroundImg})`, opacity: '0.3', }}
        // className="bg-cover bg-center h-screen flex items-center justify-center"
        className="relative inset-0 bg-cover bg-center w-full h-full"
      ...
      style={{ backgroundImage: `url(${backgroundImg})` }}
    > */}
      {/* Content for your hero section */}
    {/* </div> */}
    {/* <div className="bg-white"> */}
      <div className="relative isolate px-6 pt-14 lg:px-8 bg-opacity-30 bg-white w-full h-full">
        <div
